...
var colMap ={
	...
	colModel: [
		...
		{name:'deptName',index:'deptName', width:'10%',align:'left',sortable:false},
		{
			...
			return  "<a href='#' btncode='101050' class='btn_look jgoption "+ (cbtnArr.indexOf('101050') == -1 ? 'lock_hide' : 'lock_show' )+"' style='' title='查看'>" +
				"<i data-method='btn_check'   class='btn-ev  fa fa-file-text pointer' style='font-size: 14px !important;'></i>" +
				"</a>" +
				"<a href='#' btncode='101030' class='jgoption "+ (cbtnArr.indexOf('101030') == -1 ? 'lock_hide' : 'lock_show' )+"' style='padding-left: 5px;' title='编辑'>" +
				...
				"</a>" +
				"<a href='#' btncode='101040' class='jgoption "+ (cbtnArr.indexOf('101040') == -1 ? 'lock_hide' : 'lock_show' )+"' style='' title='注销'>" +
